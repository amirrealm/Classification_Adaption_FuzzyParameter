function z = fc_Save_Supervised_constant(KTX, Parameter, name, name_3)
% This function saves the supervised adaptation parameters for the "constant" method.
% It creates a `.ktx` file with updated parameter values formatted for further analysis.

%% Construct File Name and Title
name1 = 'Adaption_Supervised_Constant_';
name2 = '.ktx';
