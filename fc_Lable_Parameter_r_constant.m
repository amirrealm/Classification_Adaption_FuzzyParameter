function [Parameter] = fc_Lable_Parameter_r_constant(Xinput, Parameter, r, idx)
...
idxx = size(vParameter_r_Supervise(idx).Constant, 1);
% Store the updated 'r' values in the tracking variable
vParameter_r_Supervise(idx).Constant(idxx + 1, :) = change;
