function z = fc_Save_UnSupervised_relative(KTX, Parameter, name, name_3)
% This function saves the unsupervised adaptation parameters for the "Relative" method.
% It creates a `.ktx` file with formatted parameter values for further analysis.

%% Construct File Name and Title
name1 = 'Adaption_UnSupervised_Relative_';
name2 = '.ktx';
