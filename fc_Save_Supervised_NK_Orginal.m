function z = fc_Save_Supervised_NK_Orginal(KTX, Parameter, name, name_3)
% This function saves the supervised adaptation parameters for the "NK_Orginal" method.
% It creates a `.ktx` file with formatted parameter values for further analysis.

%% Construct File Name and Title
name1 = 'Adaption_Supervised_NK_Orginal_';
name2 = '.ktx';
