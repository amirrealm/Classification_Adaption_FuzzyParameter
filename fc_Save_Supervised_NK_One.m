function z = fc_Save_Supervised_NK_One(KTX, Parameter, name, name_3)
% This function saves the supervised adaptation parameters for the "NK_One" method.
% It creates a `.ktx` file with formatted parameter values for further analysis.

%% Construct File Name and Title
name1 = 'Adaption_Supervised_NK_One_';
name2 = '.ktx';
