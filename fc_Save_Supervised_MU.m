function z = fc_Save_Supervised_MU(KTX, Parameter, name, name_3)
% This function saves the supervised adaptation parameters for the "MU" method.
% It creates a `.ktx` file with formatted parameter values for further analysis.

%% Construct File Name and Title
name1 = 'Adaption_Supervised_MU_';
name2 = '.ktx';
