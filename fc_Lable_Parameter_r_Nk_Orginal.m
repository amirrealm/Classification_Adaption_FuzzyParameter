function [Parameter, NK_Orginal] = fc_Lable_Parameter_r_Nk_Orginal(Xinput, Parameter, NK_Orginal, idx)
...
%
% Update formula:
% factor1 = NK_Orginal / (NK_Orginal + 1)
% factor2 = 1 / (NK_Orginal + 1)
...
idxx = size(vParameter_r_Supervise(idx).NK_Orginal, 1);
% Store the updated 'r' values in the tracking variable
vParameter_r_Supervise(idx).NK_Orginal(idxx + 1, :) = change;
